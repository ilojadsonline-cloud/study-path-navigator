  ...
  public: {
    Tables: {
      ...
      pmto_fontes_oficiais: {
        ...
        Relationships: [
          {
            foreignKeyName: "pmto_fontes_oficiais_curso_id_fkey"
            columns: ["curso_id"]
            isOneToOne: false
            referencedRelation: "cursos"
            referencedColumns: ["id"]
      ...
      pmto_questoes_editoriais: {
        ...
        Relationships: [
          {
            foreignKeyName: "pmto_questoes_editoriais_curso_id_fkey"
            columns: ["curso_id"]
            isOneToOne: false
            referencedRelation: "cursos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "pmto_questoes_editoriais_questao_id_fkey"
            columns: ["questao_id"]
            isOneToOne: false
            referencedRelation: "questoes"
            referencedColumns: ["id"]
